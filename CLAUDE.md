...
Current state: **19 unit runs, 23,305 checks; 13 end-to-end cases, 38 checks; 2 Qt runs, 116 checks;
1,806 golden-master digests; 18 NO_FIX_* witnesses; 0 failures.**

🔴 **DO NOT READ 23,305 AS A MEASURE OF REACH. Three files are 95% of it.**
